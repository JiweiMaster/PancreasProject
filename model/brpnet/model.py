...
from brpnet.DenseNet import densenet121_backbone
...
class UNet(nn.Module):
    ...
    def forward(self, img):
        ...
        sout = self.out_s(conv_0c_s) # out_s(),out_c()都是1*1的卷积
        cout = self.out_c(conv_0c_c) # out_s(),out_c()都是1*1的卷积
